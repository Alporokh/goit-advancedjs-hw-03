import{r as e}from"./assets/rolldown-runtime-Cq0jCQ29.js";import{i as t,n,r,t as i}from"./assets/vendor-D3B9a9C6.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var a=e(t(),1),o=`55511157-7a64d58fac1bd8bae601b6272`,s=`https://pixabay.com/api/`;async function c(e){return(await r.get(s,{params:{key:o,q:e,image_type:`photo`,orientation:`horizontal`,safesearch:!0}})).data}var l=e(n(),1),u=l.default.default||l.default;i.register();var d=document.querySelector(`.gallery`),f=document.querySelector(`.loader-wrapper`),p=new u(`.gallery a`,{captionsData:`alt`,captionDelay:250});function m(e){let t=e.map(({webformatURL:e,largeImageURL:t,tags:n,likes:r,views:i,comments:a,downloads:o})=>`
